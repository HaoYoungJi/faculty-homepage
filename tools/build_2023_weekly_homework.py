...
weeks = [
    ...
    ("春季", "第五周", (2010, 2065), [(2120, 2303, "enumerate")]),
    ("春季", "第六周", (2071, 2110), [(2309, 2507, "enumerate")]),
    ("春季", "第九周", (2919, 3650), [(2512, 2911, "enumerate")]),
    ("春季", "第十二周", (4052, 4094), [(4102, 4238, "enumerate")]),
    ("春季", "第十四周", (4243, 4278), []),
    ("春季", "第十五周", (4282, 4485), []),
]
...
document = [
    ...
    r"\begin{document}",
    r"\maketitle",
    r"\noindent\textbf{编排说明：}本册按原稿标出的周次或日期整理，逐周先列作业，再列对应的部分参考答案。原稿未附对应答案的周次已明确标注。期中考试与春季小测验未收入本册；题目与解答的数学内容保持原稿写法。",
    r"\vspace{1em}",
    r"\tableofcontents",
    r"\clearpage",
    r"\chapter{秋季学期}",
